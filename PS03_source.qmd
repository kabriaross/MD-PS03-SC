...
-   The last city in the `txhousing` is **Wichita Falls** 
:::
...
-   The `listings` variable is **Total active listings**
:::
...
* The code includes all cities from 2013, not just Dallas.
:::
...
-   It calculates the **average percentage of houses sold in Dallas** for each month in 2012–2013 and ranks the months from highest to lowest.
:::
